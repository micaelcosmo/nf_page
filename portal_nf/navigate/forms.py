...
class ExperimentalClassesForm(forms.ModelForm):
    class Meta:
        model = ExperimentalClass
        fields = ['name', 'email', 'phone', 'weekly_day', 'level', 'start_hour', 'end_hour','modality', 'status', 'observations']
        labels = {
            'name': 'Nome',
            'email': 'E-mail',
            'phone': 'Telefone',
        ...
        widgets = {
            ...
            'end_hour': forms.TimeInput(attrs={'placeholder': 'Hora de fim', 'class': 'form-control'}),
            'modality': forms.TextInput(attrs={'placeholder': 'Modalidade', 'class': 'form-control'}),
            'status': forms.TextInput(attrs={'placeholder': 'Status', 'class': 'form-control'}),
            'observations': forms.TextInput(attrs={'placeholder': 'Observações', 'class': 'form-control'}),
        }
